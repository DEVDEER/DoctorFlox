namespace devdeer.DoctorFlox.Interfaces
{
    ...
    /// <summary>
    /// Must be implemented by messenger types.
    /// </summary>
    public interface IMessenger
    {
        ...
        /// of type TMessage is sent.
        /// </param>
        /// <param name="threadCallbackOption">The options for defining the callback.</param>
        void Register<TMessage>(object recipient, ThreadCallbackOption threadCallbackOption, Action<TMessage> action);
        ...
        /// </param>
        /// <param name="threadCallbackOption">The options for defining the callback.</param>
        void Register<TMessage>(object recipient, ThreadCallbackOption threadCallbackOption, object token, bool receiveDerivedMessagesToo, Action<TMessage> action);
